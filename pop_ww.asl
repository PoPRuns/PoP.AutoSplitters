...
startup
{
    ...
    vars.splitsData = new Dictionary<string, Tuple<bool, string, string, string, Func<bool>>> {
        ...
        { "AnyNmgShadeeFight",      Tuple.Create(true,  "A Damsel In Distress (Fight with Shadee)",     "AnyNMG",       "Split before the fight with Shahdee",                                                                  new Func<bool>(() => vars.shahdeeFight()        )) },
        ...
        { "AnyNmg_spPortal",        Tuple.Create(false, "Southern Passage (Portal)",                    "AnyNMG",       "Split when you entered the Southern Passage portal",                                                   new Func<bool>(() => vars.spPortal()            )) },
        ...
        { "AnyNmgHElpHand",         Tuple.Create(true,  "A Helping Hand (Portal)",                      "AnyNMG",       "Split after the first escape from the Dahaka (When entered the portal)",                               new Func<bool>(() => vars.EscapeDahaka01()      )) },
        ...
        { "AnyNmg_Second_Tower",    Tuple.Create(false, "The Second Tower",                             "AnyNMG",       "Split before the mechanical tower(before fight)",                                                      new Func<bool>(() => vars.theSecondTower()      )) },
        ...
        { "AnyNmg_arPortal",        Tuple.Create(true,  "Activation room (Portal)",                     "AnyNMG",       "Split when you entered the Activation Room portal",                                                    new Func<bool>(() => vars.arPortal()            )) },
        ...
        { "AnyNmg16",               Tuple.Create(false, "The death of a sand wraith (central hall)",    "AnyNMG",       "Split in central hall next to the fountain after you've activated both towers",                        new Func<bool>(() => vars.sandWraithDeathV1()   )) },
        { "AnyNmg17",               Tuple.Create(true,  "The death of a sand wraith v2 (central hall)", "AnyNMG",       "Alternate split located deeper into the corridor so you can't hit it early when jumping down",         new Func<bool>(() => vars.sandWraithDeathV2()   )) },
        ...
        { "AnyNmgTomb",             Tuple.Create(true,  "Enter the tomb after cutscene",                "AnyNMG",       "Split when you enter the tomb",                                                                        new Func<bool>(() => vars.Tomb()                )) },
        ...
        { "AnyNmg_prPortal",        Tuple.Create(false, "Prison Portal (Portal)",                       "AnyNMG",       "Split when you entered the Prison portal",                                                             new Func<bool>(() => vars.prPortal()            )) },
        ...
        { "AnyNmg21",               Tuple.Create(true,  "Library",                                      "AnyNMG",       "Split on the library opening cutscene",                                                                new Func<bool>(() => vars.libraryV1()           )) },
        { "AnyNmg22",               Tuple.Create(false, "Library v2",                                   "AnyNMG",       "Split when you move into the library (after the opening cutscene)",                                    new Func<bool>(() => vars.libraryV2()           )) },
        { "AnyNmg_LibraryV3",       Tuple.Create(false, "Library v3",                                   "AnyNMG",       "Split when you move into the library (An alternative to the cutscene)",                                new Func<bool>(() => vars.libraryV3()           )) },
        ...
        { "AnyNmg_trPortal",        Tuple.Create(false, "Throne Room (Portal)",                         "AnyNMG",       "Split when you entered the Throne Room portal",                                                        new Func<bool>(() => vars.trPortal()            )) },
        ...
        { "AnyNmg_scPortal",        Tuple.Create(false, "Sacred Caves (Portal)",                        "AnyNMG",       "Split when you entered the Secret Caves portal",                                                       new Func<bool>(() => vars.scPortal()            )) },
        ...
        { "AnyNmg_ugPortal",        Tuple.Create(false, "Upper Garden (Portal)",                        "AnyNMG",       "Split when you entered the Garden Upper Portal",                                                       new Func<bool>(() => vars.ugPortal()            )) },
        ...
        { "AnyNmgCave",             Tuple.Create(true,  "Mystic Caves",                                 "AnyNMG",       "Split when you enter mystic caves",                                                                    new Func<bool>(() => vars.mysticcaves()         )) },
        ...
        { "AnyNmgMechTWCave",       Tuple.Create(true,  "Mechanical tower (Mystic Caves)",              "AnyNMG",       "Split upon entering the Mechanical Tower from the cave entrance",                                      new Func<bool>(() => vars.mechtowercave()       )) },
        ...
        { "AnyNmgKaileenaPresent",  Tuple.Create(true,  "Kaileena in present",                          "AnyNMG",       "Split as you enter the portal after forcing Kaileena through",                                         new Func<bool>(() => vars.kaileenaPresent()     )) },
        ...
        { "TeNmgShadeeFight",       Tuple.Create(true,  "A Damsel In Distress (Fight with Shadee)",     "TENMG",        "Split before the fight with Shahdee",                                                                  new Func<bool>(() => vars.shahdeeFight()        )) },
        ...
        { "TeNmg_spPortal",         Tuple.Create(false, "Southern Passage (Portal)",                    "TENMG",        "Split when you entered the Southern Passage portal",                                                   new Func<bool>(() => vars.spPortal()            )) },
        ...
        { "TeNmgHElpHand",          Tuple.Create(true,  "A Helping Hand (Portal)",                      "TENMG",        "Split after the first escape from the Dahaka (When entered the portal)",                               new Func<bool>(() => vars.EscapeDahaka01()      )) },
        ...
        { "TeNmg_Second_Tower",     Tuple.Create(false, "The Second Tower",                             "TENMG",        "Split before the mechanical tower(before fight)",                                                      new Func<bool>(() => vars.theSecondTower()      )) },
        ...
        { "TeNmg_arPortal",         Tuple.Create(true,  "Activation room (Portal)",                     "TENMG",        "Split when you entered the Activation Room portal",                                                    new Func<bool>(() => vars.arPortal()            )) },
        ...
        { "TeNmg24",                Tuple.Create(false, "The death of a sand wraith (central hall)",    "TENMG",        "Split in central hall next to the fountain after you've activated both towers",                        new Func<bool>(() => vars.sandWraithDeathV1()   )) },
        { "TeNmg25",                Tuple.Create(true,  "The death of a sand wraith v2 (central hall)", "TENMG",        "Alternate split located deeper into the corridor so you can't hit it early when jumping down",         new Func<bool>(() => vars.sandWraithDeathV2()   )) },
        ...
        { "TeNmgTomb",              Tuple.Create(true,  "Enter the tomb after cutscene",                "TENMG",        "Split when you enter the tomb",                                                                        new Func<bool>(() => vars.Tomb()                )) },
        ...
        { "TeNmg_prPortal",         Tuple.Create(false, "Prison Portal (Portal)",                       "TENMG",        "Split when you entered the Prison portal",                                                             new Func<bool>(() => vars.prPortal()            )) },
        ...
        { "TeNmg30",                Tuple.Create(true,  "Library",                                      "TENMG",        "Split on the library opening cutscene",                                                                new Func<bool>(() => vars.libraryV1()           )) },
        ...
        { "TeNmg_LibraryV3",        Tuple.Create(false, "Library v3",                                   "TENMG",        "Split when you move into the library (An alternative to the cutscene)",                                new Func<bool>(() => vars.libraryV3()           )) },
        ...
        { "TeNmg_trPortal",         Tuple.Create(false, "Throne Room (Portal)",                         "TENMG",        "Split when you entered the Throne Room portal",                                                        new Func<bool>(() => vars.trPortal()            )) },
        ...
        { "TeNmg_scPortal",         Tuple.Create(false, "Sacred Caves (Portal)",                        "TENMG",        "Split when you entered the Secret Caves portal",                                                       new Func<bool>(() => vars.scPortal()            )) },
        ...
        { "TeNmg_ugPortal",         Tuple.Create(false, "Upper Garden (Portal)",                        "TENMG",        "Split when you entered the Garden Upper Portal",                                                       new Func<bool>(() => vars.ugPortal()            )) },
        ...
        { "TeNmgCave",              Tuple.Create(true,  "Mystic Caves",                                 "TENMG",        "Split when you enter mystic caves",                                                                    new Func<bool>(() => vars.mysticcaves()         )) },
        ...
        { "TeNmgMechTWCave",        Tuple.Create(true,  "Mechanical tower (Mystic Caves)",              "TENMG",        "Split upon entering the Mechanical Tower from the cave entrance",                                      new Func<bool>(() => vars.mechtowercave()       )) },
        ...
        { "TeNmgKaileenaPresent",   Tuple.Create(true,  "Kaileena in present",                          "TENMG",        "Split as you enter the portal after forcing Kaileena through",                                         new Func<bool>(() => vars.kaileenaPresent()     )) },
...
init
{
    ...
    vars.firstPortal        = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285231807 }) && current.storyValue == 2;                                           });
    ...
    vars.shahdeeFight       = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285225353 }) && current.storyValue == 8;                                           });
    ...
    vars.spPortal           = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285235301 }) && current.storyValue == 8;                                           });
    ...
    vars.EscapeDahaka01     = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285231807 }) && current.storyValue == 10;                                          });
    ...
    vars.theSecondTower     = (Func<bool>)(() => { return current.map == 687907863 && vars.oldZ < 402 && current.zPos >= 400 && current.storyValue == 15;                               });
    ...
    vars.arPortal           = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285235369 }) && current.storyValue == 18;                                          });
    ...
    vars.sandWraithDeathV2  = (Func<bool>)(() => { return current.map == 67112526 && vars.oldY < -7 && current.yPos >= -9 && current.storyValue == 33;                                  });
    vars.kaileenaFirst      = (Func<bool>)(() => { return vars.splitByStoryGate(38);                                                                                                    });
    vars.Tomb               = (Func<bool>)(() => { return vars.splitByXYZ(-94f, -93.5f, -193f, -185f, 18f, 18.1f) && current.storyValue == 39;                                          });
    ...
    vars.prPortal           = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285235334 }) && current.storyValue == 40;                                          });
    vars.prPortalExit       = (Func<bool>)(() => { return vars.splitByXYZ(-71f, -69f, -117f, -115f, 319.8f, 320.2f);                                                                    });
    vars.libraryV1          = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 67116816, 67116821 });                                                             });
    vars.libraryV2          = (Func<bool>)(() => { return current.map == 67116821 && vars.oldX < -112 && current.xPos >= -112 && current.storyValue == 42;                              });
    vars.libraryV3          = (Func<bool>)(() => { return current.map == 67116821 && current.storyValue == 42 && vars.oldX < -114 && current.xPos >= -115;                              });
    vars.hourglassRevisit   = (Func<bool>)(() => { return vars.oldMap == 1006704427 && current.map == 1006704429 && current.storyValue == 45;                                           });
    vars.trPortalEnter      = (Func<bool>)(() => { return vars.oldMap == 1006704431 && current.map == -1509855113 && current.storyValue == 45;                                          });
    vars.trPortal           = (Func<bool>)(() => { return vars.oldMap == -1509855113 && current.map == 285233488 && current.storyValue == 45;                                           });
    ...
    vars.scPortal           = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285233531 }) && current.storyValue == 47;                                          });
    ...
    vars.ugPortal           = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 285235445 }) && current.storyValue == 50;                                          });
    ...
    vars.mysticcaves        = (Func<bool>)(() => { return vars.oldMap == 67116810 && current.map == 1006801523 && current.storyValue == 60;                                             });
    vars.mechtowercave      = (Func<bool>)(() => { return vars.splitByXYZ(-218f, -216f, 0.4f, 4f, 445f, 446f) && current.map == 67111336 && current.storyValue == 61 ;                  });
    vars.maskOff            = (Func<bool>)(() => { return vars.splitCutsceneByMap(new HashSet<int> { 67112526 }) && current.storyValue == 64;                                           });
    vars.kaileenaPresent    = (Func<bool>)(() => { return vars.oldMap == -1509855113 && current.map == 285233488 && current.storyValue == 66;                                           });
