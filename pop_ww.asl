...
startup
{
    ...
    vars.splitsData = new Dictionary<string, Tuple<bool, string, string, string, Func<bool>>> {
        ...
        { "AnyNmg16",               Tuple.Create(true,  "The death of a sand wraith (central hall)",    "AnyNMG",       "Split in central hall next to the fountain after you've activated both towers",                        new Func<bool>(() => vars.sandWraithDeathV1()   )) },
        { "AnyNmg17",               Tuple.Create(false, "The death of a sand wraith v2 (central hall)", "AnyNMG",       "Alternate split located deeper into the corridor so you can't hit it early when jumping down",         new Func<bool>(() => vars.sandWraithDeathV2()   )) },
        ...
        { "AnyNmg_LibraryV3",       Tuple.Create(true,  "Library v3",                                   "AnyNMG",       "Split when you move into the library (An alternative to the cutscene)",                                new Func<bool>(() => vars.libraryV3()           )) },
        ...
        { "TeNmg24",                Tuple.Create(true,  "The death of a sand wraith (central hall)",    "TENMG",        "Split in central hall next to the fountain after you've activated both towers",                        new Func<bool>(() => vars.sandWraithDeathV1()   )) },
        { "TeNmg25",                Tuple.Create(false, "The death of a sand wraith v2 (central hall)", "TENMG",        "Alternate split located deeper into the corridor so you can't hit it early when jumping down",         new Func<bool>(() => vars.sandWraithDeathV2()   )) },
