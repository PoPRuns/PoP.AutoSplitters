...
startup
{
    ...
    vars.splitsData = new Dictionary<string, Tuple<bool, string, string, Func<bool>>> {
        ...
        {"SultanChamberZipless", Tuple.Create(false, "The Sultan's Chamber", "Split on entering the Sultan's chamber at the cutscene", new Func<bool>(() => vars.SultanChamberZipless()))},
        ...
        {"DadStart", Tuple.Create(false, "The Sand King", "Split on starting the fight with the Sand King", new Func<bool>(() => vars.DadStart()))},
        {"DadDead", Tuple.Create(true, "Death of the Sand King", "Split at the end of the fight on loading the next area", new Func<bool>(() => vars.DadDead()))},
