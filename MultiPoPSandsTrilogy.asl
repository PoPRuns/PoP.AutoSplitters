...
split{	
	...
	vars.HarbourDistrict = (Func <bool>)(() => {
		if(current.xPos3 >= -271			&& current.yPos3 >= 187			&& current.zPos3 >= 74			&& current.xPos3 <= -265			&& current.yPos3 <= 188			&& current.zPos3 <= 75)
			return true;
		else
			return false;
	});
	vars.ThePalace = (Func <bool>)(() => {
		if(current.xPos3 >= -93			&& current.yPos3 >= 236.2		&& current.zPos3 >= 83			&& current.xPos3 <= -88			&& current.yPos3 <= 238			&& current.zPos3 <= 88)
			return true;
		else
			return false;
	});
	vars.DaggerofTime = (Func <bool>)(() => {
		if(current.xPos3 >= -35.5		&& current.yPos3 >= 232.3		&& current.zPos3 >= 146.9		&& current.xPos3 <= -35.4		&& current.yPos3 <= 232.4		&& current.zPos3 <= 147)
			return true;
		else
			return false;
	});
	vars.TheSewers = (Func <bool>)(() => {
		if(current.xPos3 >= -52.1		&& current.yPos3 >= 135.8		&& current.zPos3 >= 75.9			&& current.xPos3 <= -52.0		&& current.yPos3 <= 135.9		&& current.zPos3 <= 76)
			return true;
		else
			return false;
	});
	vars.TheTunnels = (Func <bool>)(() => {
		if(current.xPos3 >= -100			&& current.yPos3 >= -83			&& current.zPos3 >= 19.9			&& current.xPos3 <= -96			&& current.yPos3 <= -79			&& current.zPos3 <= 20)
			return true;
		else
			return false;
	});
	vars.TheTunnelsZipless = (Func <bool>)(() => {
		if(current.xPos3 >= -88.6		&& current.yPos3 >= -14.8		&& current.zPos3 >= 4.9			&& current.xPos3 <= -88.5		&& current.yPos3 <= -14.7		&& current.zPos3 <= 5.1)
			return true;
		else
			return false;
	});
	vars.TheLowerCity = (Func <bool>)(() => {
		if(current.xPos3 >= -71.4		&& current.yPos3 >= 9.6			&& current.zPos3 >= 44			&& current.xPos3 <= -71.3		&& current.yPos3 <= 9.7			&& current.zPos3 <= 44.1)
			return true;
		else
			return false;
	});
	vars.LowerCityRooftops = (Func <bool>)(() => {
		if(current.xPos3 >= -319			&& current.yPos3 >= 317			&& current.zPos3 >= 95.1			&& current.xPos3 <= -316.5		&& current.yPos3 <= 332.6		&& current.zPos3 <= 98)
			return true;
		else
			return false;
	});
	vars.KlompaDead = (Func <bool>)(() => {
		if(current.xPos3 >= -261.5		&& current.yPos3 >= 318			&& current.zPos3 >= 46			&& current.xPos3 <= -261			&& current.yPos3 <= 319.5		&& current.zPos3 <= 48)
			return true;
		else
			return false;
	});
	vars.KlompaSkip = (Func <bool>)(() => {
		if(current.xPos3 >= -246			&& current.yPos3 >= 373.5		&& current.zPos3 >= 66			&& current.xPos3 <= -241.5		&& current.yPos3 <= 383.6		&& current.zPos3 <= 69)
			return true;
		else
			return false;
	});
	vars.CringeofPersia = (Func <bool>)(() => {
		if(current.xPos3 >= -194			&& current.yPos3 >= 328			&& current.zPos3 >= 32.6			&& current.xPos3 <= -190			&& current.yPos3 <= 329.7		&& current.zPos3 <= 33.6)
			return true;
		else
			return false;
	});
	vars.TempleRooftops = (Func <bool>)(() => {
		if(current.xPos3 >= -114			&& current.yPos3 >= 328			&& current.zPos3 >= 55			&& current.xPos3 <= -110			&& current.yPos3 <= 338			&& current.zPos3 <= 59)
			return true;
		else
			return false;
	});
	vars.TheTemple = (Func <bool>)(() => {
		if(current.xPos3 >= -122.6		&& current.yPos3 >= 421.6		&& current.zPos3 >= 107			&& current.xPos3 <= -117.7		&& current.yPos3 <= 423			&& current.zPos3 <= 108.1)
			return true;
		else
			return false;
	});
	vars.MarketDistrict = (Func <bool>)(() => {
		if(current.xPos3 >= -213			&& current.yPos3 >= 484			&& current.zPos3 >= 101			&& current.xPos3 <= -207			&& current.yPos3 <= 490			&& current.zPos3 <= 103)
			return true;
		else
			return false;
	});
	vars.TheBowery = (Func <bool>)(() => {
		if(current.xPos3 >= -185.5		&& current.yPos3 >= 524			&& current.zPos3 >= 90			&& current.xPos3 <= -175.5		&& current.yPos3 <= 530			&& current.zPos3 <= 92)
			return true;
		else
			return false;
	});
	vars.TheBrothel = (Func <bool>)(() => {
		if(current.xPos3 >= -152.6		&& current.yPos3 >= 549.8		&& current.zPos3 >= 91.9			&& current.xPos3 <= -152.5		&& current.yPos3 <= 549.9		&& current.zPos3 <= 92)
			return true;
		else
			return false;
	});
	vars.MahastiDead = (Func <bool>)(() => {
		if(current.xPos3 >= -104			&& current.yPos3 >= 548			&& current.zPos3 >= 105.9		&& current.xPos3 <= -100			&& current.yPos3 <= 553			&& current.zPos3 <= 106.1)
			return true;
		else
			return false;
	});
	vars.TheUpperCity = (Func <bool>)(() => {
		if(current.xPos3 >= -124.5		&& current.yPos3 >= 500			&& current.zPos3 >= 97			&& current.xPos3 <= -122.5		&& current.yPos3 <= 505			&& current.zPos3 <= 99)
			return true;
		else
			return false;
	});
	vars.StoneGuardian = (Func <bool>)(() => {
		if(current.xPos3 >= -63.5		&& current.yPos3 >= 389.7		&& current.zPos3 >= 85.2			&& current.xPos3 <= -63.4		&& current.yPos3 <= 389.8		&& current.zPos3 <= 85.3)
			return true;
		else
			return false;
	});
	vars.TheRoyalWorkshop = (Func <bool>)(() => {
		if(current.xPos3 >= -3			&& current.yPos3 >= 515			&& current.zPos3 >= 72			&& current.xPos3 <= -1			&& current.yPos3 <= 519			&& current.zPos3 <= 75)
			return true;
		else
			return false;
	});
	vars.KingsRoad = (Func <bool>)(() => {
		if(current.xPos3 >= 58			&& current.yPos3 >= 470			&& current.zPos3 >= 79			&& current.xPos3 <= 62			&& current.yPos3 <= 480			&& current.zPos3 <= 81)
			return true;
		else
			return false;
	});
	vars.TwinsDead = (Func <bool>)(() => {
		if(current.xPos3 >= 91.7802		&& current.yPos3 >= 229.6516		&& current.zPos3 >= 70.9877		&& current.xPos3 <= 91.7804		&& current.yPos3 <= 229.6518		&& current.zPos3 <= 70.9879)
			return true;
		else
			return false;
	});
	vars.TwinsSkip = (Func <bool>)(() => {
		if(current.xPos3 >= 53			&& current.yPos3 >= 240			&& current.zPos3 >= 70			&& current.xPos3 <= 70			&& current.yPos3 <= 250			&& current.zPos3 <= 73)
			return true;	
		else
			return false;
	});
	vars.PalaceEntrance = (Func <bool>)(() => {
		if(current.xPos3 >= 30.8			&& current.yPos3 >= 271.2		&& current.zPos3 >= 126			&& current.xPos3 <= 30.9			&& current.yPos3 <= 271.3		&& current.zPos3 <= 126.1)
			return true;	
		else
			return false;
	});
	vars.HangingGardens = (Func <bool>)(() => {
		if(current.xPos3 >= 4			&& current.yPos3 >= 211		&& current.zPos3 >= 194.8		&& current.xPos3 <= 7			&& current.yPos3 <= 217		&& current.zPos3 <= 195.2)
			return true;	
		else
			return false;
	});
	vars.StructuresMindNMG = (Func <bool>)(() => {
		if(current.xPos3 >= -34			&& current.yPos3 >= 240			&& current.zPos3 >= 178			&& current.xPos3 <= -27		&& current.yPos3 <= 250			&& current.zPos3 <= 180)
			return true;
		else
			return false;
	});
	vars.StructuresMind = (Func <bool>)(() => {
		if(current.xPos3 >= 13.5			&& current.yPos3 >= 204.4		&& current.zPos3 >= 184.9999		&& current.xPos3 <= 27.4			&& current.yPos3 <= 215.4		&& current.zPos3 <= 185.0001)
			return true;
		else
			return false;
	});
	vars.WellofZipless = (Func <bool>)(() => {
		if(current.xPos3 >= -28			&& current.yPos3 >= 250			&& current.zPos3 >= 20.9			&& current.xPos3 <= -26.5		&& current.yPos3 <= 255			&& current.zPos3 <= 30)
			return true;	
		else
			return false;
	});
	vars.WellofAncestors = (Func <bool>)(() => {
		if(current.xPos3 >= 5			&& current.yPos3 >= 243			&& current.zPos3 >= 104			&& current.xPos3 <= 12			&& current.yPos3 <= 265			&& current.zPos3 <= 104.1)
			return true;	
		else
			return false;
	});
	vars.TheLabyrinth = (Func <bool>)(() => {
		if(current.xPos3 >= -12.6		&& current.yPos3 >= 241.2		&& current.zPos3 >= 0.9			&& current.xPos3 <= -12.5		&& current.yPos3 <= 241.3		&& current.zPos3 <= 1)
			return true;
		else
			return false;
	});
	vars.UndergroundCave = (Func <bool>)(() => {
		if(current.xPos3 >= -25.5		&& current.yPos3 >= 325			&& current.zPos3 >= 35.9			&& current.xPos3 <= -23			&& current.yPos3 <= 338			&& current.zPos3 <= 36.1)
			return true;	
		else
			return false;
	});
	vars.UndergroundCaveNMG = (Func <bool>)(() => {
		if(current.xPos3 >= -11			&& current.yPos3 >= 327		&& current.zPos3 >= 73			&& current.xPos3 <= -9			&& current.yPos3 <= 334			&& current.zPos3 <= 74)
			return true;
		else
			return false;
	});
	vars.LowerTower = (Func <bool>)(() => {
		if(current.xPos3 >= 27			&& current.yPos3 >= 316.5		&& current.zPos3 >= 99.9			&& current.xPos3 <= 29			&& current.yPos3 <= 318			&& current.zPos3 <= 100.1)
			return true;	
		else
			return false;
	});
	vars.MiddleTower = (Func <bool>)(() => {
		if(current.xPos3 >= -5			&& current.yPos3 >= 316			&& current.zPos3 >= 139.9		&& current.xPos3 <= -3			&& current.yPos3 <= 317.5		&& current.zPos3 <= 140.1)
			return true;
		else
			return false;
	});
	vars.MiddleTowerNMG = (Func <bool>)(() => {
		if(current.xPos3 >= -18			&& current.yPos3 >= 303			&& current.zPos3 >= 184.8		&& current.xPos3 <= -12			&& current.yPos3 <= 305		&& current.zPos3 <= 185.1)
			return true;
		else
			return false;
	});
	vars.UpperTower = (Func <bool>)(() => {
		if(current.xPos3 >= -8			&& current.yPos3 >= 296			&& current.zPos3 >= 226.9		&& current.xPos3 <= -7			&& current.yPos3 <= 298			&& current.zPos3 <= 227)
			return true;		
		else
			return false;
	});
	vars.VizierDead = (Func <bool>)(() => {
		if(current.xPos3 >= -7.2			&& current.yPos3 >= 245.6		&& current.zPos3 >= 677			&& current.xPos3 <= -6.9			&& current.yPos3 <= 245.9		&& current.zPos3 <= 679)
			return true;		
		else
			return false;
	});
	vars.T2TEnd = (Func <bool>)(() => {
		if(current.xPos3 >= 189			&& current.yPos3 >= 319.135		&& current.zPos3 >= 542			&& current.xPos3 <= 193			&& current.yPos3 <= 320			&& current.zPos3 <= 543)
			return true;		
		else
			return false;
	});
	vars.T2TLU1 = (Func <bool>)(() => {
		if(current.xPos3 >= -14.9972		&& current.yPos3 >= -112.8152	&& current.zPos3 >= 20.0732		&& current.xPos3 <= -14.9970		&& current.yPos3 <= -112.8150	&& current.zPos3 <= 20.0734)
			return true;		
		else
			return false;
	});
	vars.T2TLU2 = (Func <bool>)(() => {
		if(current.xPos3 >= -302.0919	&& current.yPos3 >= 370.8710		&& current.zPos3 >= 52.858		&& current.xPos3 <= -302.0917	&& current.yPos3 <= 370.8712		&& current.zPos3 <= 52.8582)
			return true;		
		else
			return false;
	});
	vars.T2TLU3 = (Func <bool>)(() => {
		if(current.xPos3 >= -187.3369	&& current.yPos3 >= -455.9863	&& current.zPos3 >= 78.0330		&& current.xPos3 <= -187.3367	&& current.yPos3 <= 455.9865		&& current.zPos3 <= 78.0332)
			return true;		
		else
			return false;
	});
	vars.T2TLU4 = (Func <bool>)(() => {
		if(current.xPos3 >= -55.0147		&& current.yPos3 >= 395.7608		&& current.zPos3 >= 72.0774		&& current.xPos3 <= -55.0145		&& current.yPos3 <= 395.761		&& current.zPos3 <= 72.0776)
			return true;		
		else
			return false;
	});
	vars.T2TLU5 = (Func <bool>)(() => {
		if(current.xPos3 >= -30.1223		&& current.yPos3 >= 281.8893		&& current.zPos3 >= 104.0796		&& current.xPos3 <= -30.1221		&& current.yPos3 <= 281.8895		&& current.zPos3 <= 104.0798)
			return true;
		else
			return false;
	});
	vars.T2TLU6 = (Func <bool>)(() => {
		if(current.xPos3 >= -23.9663		&& current.yPos3 >= 253.9438		&& current.zPos3 >= 183.0634		&& current.xPos3 <= -23.9661		&& current.yPos3 <= 253.944		&& current.zPos3 <= 183.0636)
			return true;		
		else
			return false;
	});
	...
	switch(timer.Run.GetExtendedCategoryName())
	{
		...
		//T2T
			...
			//The Tunnels
			case 4:
				if(vars.TheTunnelsZipless())
					return true;
				break;
			//The Lower City
			case 5:
				if(vars.TheLowerCity())
					return true;
				break;
			//The Lower City Rooftops
			case 6:
			...
			case 8:
				if(vars.CringeofPersia())
					return true;
				break;
			//The Temple Rooftops
			case 9:
				if(vars.TempleRooftops())
					return true;
				break;
			//The Temple
			case 10:
